...
${SPARK_HOME}/bin/spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.5,ru.yandex.clickhouse:clickhouse-jdbc:0.2.4 --class Streaming --master local[3] $JARFILE